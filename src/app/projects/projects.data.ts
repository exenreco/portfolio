...
export const PROJECTS: Project[] = [
  {
    ...
    cover:        '/images/project-rhythmz.png',
    gitRepo:      '',
    aspectRatio:  12/9,
    excerpt:      'Designing for nightlife is all about energy, motion, and bold expression, which is exactly what I set out to capture with...',
    content:      `
  ...
  },
  {
    ...
    aspectRatio:  9/12,
    excerpt:      'Creating a portfolio is more than just displaying work; it\'s about crafting an experience that reflects your skills...',
    content:      `
      <section class="page remodeling">
        <article class="project">
  ...
  },
  {
    ...
    cover:        '/images/project-carebuilders-cover.png',
    gitRepo:      '',
    aspectRatio:  9/16,
    excerpt:      'Every web project is a chance to build something meaningful; However, some projects carry a deeper sense of purpose. Carebuilders at Home Omaha is one such...',
    content:      `
      <section class="page remodeling">
        <article class="project">
  ...
  },
  {
    ...
    cover:        '/images/project-mailer-cover.png',
    gitRepo:      '',
    aspectRatio:  9/12,
    excerpt:      'What starts as an academic exercise can quickly evolve into a practical tool and that’s exactly what happened with my Django...',
    content:      `
  ...
  },
  {
    ...
    cover:        '/images/project-fulton-cover.png',
    gitRepo:      '',
    aspectRatio:  9/12,
    excerpt:      'When working with WordPress, child themes offer a powerful way to extend and customize existing themes without losing the...',
    content:      `
      <section class="page mailer">
        <article class="project">
  ...
  },
  {
    ...
    cover:        '/images/project-actions-cover.png',
    gitRepo:      '',
    aspectRatio:  12/9,
    excerpt:      'Creating a simplified version of a real-world platform is a powerful way to learn web development and that’s...',
    content:      `
      <section class="page mailer">
        <article class="project">
  ...
  },
  {
    ...
    cover:        '/images/project-wiki-cover.png',
    gitRepo:      '',
    aspectRatio:  9/12,
    excerpt:      'Sometimes the simplest ideas make the most enduring tools. What began as a school assignment creating a...',
    content:      `
      <section class="page mailer">
        <article class="project">
  ...
  },
  {
    ...
    cover:        '/images/project-alkamist-cover.png',
    gitRepo:      '',
    aspectRatio:  12/9,
    excerpt:      'A portfolio theme needs to balance aesthetic flair with flexibility and performance. For my primary portfolio, I developed...',
    content:      `
      <section class="page mailer">
        <article class="project">
